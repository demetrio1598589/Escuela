...
<body>
    ...
    <main class="dashboard">
        ...
        <div class="content">
            ...
            <p>Bienvenido, <?= htmlspecialchars($_SESSION['nombre']) ?>. Aquí puedes ver y gestionar tu perfil.</p><br>
            ...
            <div class="profile-section">
                ...
                <a href="contrasenaestudiante.php" class="btn">Cambiar Contraseña</a>
            </div>
        </div>
    </main>
